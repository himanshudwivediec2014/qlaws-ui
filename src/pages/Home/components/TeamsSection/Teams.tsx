...
const TeamsSection: React.FC = () => {
    return (
        <div className={`${styles["our-team-section"]} flex flex-col items-center`}>
            <motion.div 
                className={`${styles["our-team-titel-section"]} flex flex-col items-center`}
            ...
            >
                ...
                >
                    <h6 className={`${styles["team-badge-text"]} text-center`}>Our Team</h6>
                </motion.div>
