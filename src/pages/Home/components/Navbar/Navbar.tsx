...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className={`${styles.navbar} flex items-center justify-between px-[23px] pt-3 pb-2 rounded-[14px]`}>
        <motion.div 
          className={`${styles.logo} w-[135px] h-[35px] flex justify-start items-center cursor-pointer`}
          whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}
        >
          <div className={styles["logo-img"]} />
          <h6 className={`${styles["logo-text"]} m-0 font-medium text-[23.9px] leading-none text-primary`}>
            Laws.ai
          </h6>
        </motion.div>
